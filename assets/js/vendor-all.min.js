!(function (e, t) {
    ...
    function u(e) {
        var t = {};
        return (
            xe.each(e.match(Oe) || [], function (e, n) {
                t[n] = !0;
            }),
            t
        );
    ...
    function y(e, t, n, r) {
        ...
        if (c && c[3] !== l) {
            for (u /= 2, l = l || c[3], c = +u || 1; a--; ) xe.style(e, t, c + l), (1 - i) * (1 - (i = s() / u || 0.5)) <= 0 && (a = 0), (c /= i);
    ...
    function w(e, t) {
        for (var n, r, o = [], i = 0, a = e.length; i < a; i++)
            (r = e[i]).style &&
                ((n = r.style.display),
                t ? ("none" === n && ((o[i] = Ie.get(r, "display") || null), o[i] || (r.style.display = "")), "" === r.style.display && Ue(r) && (o[i] = b(r))) : "none" !== n && ((o[i] = "none"), Ie.set(r, "display", n)));
        ...
        if (p && ((i = C(t, e[0].ownerDocument, !1, e, o)), (a = i.firstChild), 1 === i.childNodes.length && (i = a), a || o)) {
            ...
            if (u)
                for (c = s[s.length - 1].ownerDocument, xe.map(s, j), f = 0; f < u; f++)
                    (l = s[f]), Qe.test(l.type || "") && !Ie.access(l, "globalEval") && xe.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? xe._evalUrl && xe._evalUrl(l.src) : n(l.textContent.replace(st, ""), c, l));
        }
        return e;
    }
    function q(e, t, n) {
    ...
    function M(e, t, n) {
        ...
        return (
            (n = n || lt(e)) &&
                ...
                !ve.pixelBoxStyles() && ut.test(a) && ct.test(t) && ((r = s.width), (o = s.minWidth), (i = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = r), (s.minWidth = o), (s.maxWidth = i))),
            void 0 !== a ? a + "" : a
        );
    }
    function P(e, t) {
    ...
    function W(e, t, n, r, o, i) {
        ...
        for (; a < 4; a += 2)
            "margin" === n && (u += xe.css(e, n + Ye[a], !0, o)),
                r
                    ? ("content" === n && (u -= xe.css(e, "padding" + Ye[a], !0, o)), "margin" !== n && (u -= xe.css(e, "border" + Ye[a] + "Width", !0, o)))
                    : ((u += xe.css(e, "padding" + Ye[a], !0, o)), "padding" !== n ? (u += xe.css(e, "border" + Ye[a] + "Width", !0, o)) : (s += xe.css(e, "border" + Ye[a] + "Width", !0, o)));
    ...
    function X(e, t, n) {
        ...
        if ((u = !xe.isEmptyObject(t)) || !xe.isEmptyObject(d)) {
            ...
            for (r in d)
                u ||
                    (g ? "hidden" in g && (m = g.hidden) : (g = Ie.access(e, "fxshow", { display: l })),
                    i && (g.hidden = !m),
                    m && w([e], !0),
                    p.done(function () {
    ...
    function K(e, t, n) {
        var r,
            ...
            c = l.props;
        for (V(c, l.opts.specialEasing); i < a; i++) if ((r = K.prefilters[i].call(l, e, c, l.opts))) return ye(r.stop) && (xe._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
        return (
            xe.map(c, U, l),
            ...
            for ("boolean" == typeof a && ((l = a), (a = arguments[s] || {}), s++), "object" == typeof a || ye(a) || (a = {}), s === u && ((a = this), s--); s < u; s++)
                if (null != (e = arguments[s]))
                    for (t in e)
                        (n = a[t]),
                            a !== (r = e[t]) &&
                                (l && r && (xe.isPlainObject(r) || (o = Array.isArray(r)))
                                    ? (o ? ((o = !1), (i = n && Array.isArray(n) ? n : [])) : (i = n && xe.isPlainObject(n) ? n : {}), (a[t] = xe.extend(l, i, r)))
                                    : void 0 !== r && (a[t] = r));
            return a;
        }),
        xe.extend({
    ...
    var Ce = (function (e) {
            ...
            for (
                ...
                if ((n = x.relative[e[s].type])) c = [p(d(c), n)];
                    ...
                    if ((n = x.filter[e[s].type].apply(null, e[s].matches))[B]) {
                        ...
                        return g(s > 1 && d(c), s > 1 && f(e.slice(0, s - 1).concat({ value: " " === e[s - 2].type ? "*" : "" })).replace(ie, "$1"), n, s < r && v(e.slice(s, r)), r < o && v((e = e.slice(r))), r < o && f(e));
                    }
                    c.push(n);
                }
            return d(c);
        ...
        (w = t.support = {}),
            ...
            (j = t.setDocument = function (e) {
                ...
                return r !== L && 9 === r.nodeType && r.documentElement
                    ? ((L = r),
                      ...
                      (M = []),
                      (q = []),
                      (w.qsa = he.test(L.querySelectorAll)) &&
                          (o(function (e) {
                      ...
                      (w.matchesSelector = he.test((P = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector))) &&
                          o(function (e) {
                          ...
                          ? function (e, t) {
                                ...
                                return (
                                    ...
                                    (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!w.sortDetached && t.compareDocumentPosition(e) === n)
                                        ? e === L || (e.ownerDocument === I && R(I, e))
                                            ? -1
                                            : t === L || (t.ownerDocument === I && R(I, t))
                                            ? 1
                                            : N
                                            ? J(N, e) - J(N, t)
                                            : 0
            ...
            (t.matchesSelector = function (e, n) {
                if (((e.ownerDocument || e) !== L && j(e), (n = n.replace(ue, "='$1']")), w.matchesSelector && H && !_[n + " "] && (!M || !M.test(n)) && (!q || !q.test(n))))
                    try {
                        var r = P.call(e, n);
                            ...
                            : function (t, n, u) {
                                  ...
                                  if (g) {
                                      ...
                                      if (((h = [a ? g.firstChild : g.lastChild]), a && y)) {
                                          for (
                                              b = (d = (l = (c = (f = (p = g)[B] || (p[B] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === W && l[1]) && l[2], p = d && g.childNodes[d];
                                          ...
                                          for (
                                              ;
                                              (p = (++d && p && p[m]) || (b = d = 0) || h.pop()) &&
                                              ((s ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && ((c = (f = p[B] || (p[B] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [W, b]), p !== t));
        ...
        return (
            ...
            (E = t.tokenize = function (e, n) {
                ...
                for (s = e, u = [], l = x.preFilter; s; ) {
                    (r && !(o = ae.exec(s))) || (o && (s = s.slice(o[0].length) || s), u.push((i = []))), (r = !1), (o = se.exec(s)) && ((r = o.shift()), i.push({ value: r, type: o[0].replace(ie, " ") }), (s = s.slice(r.length)));
                    for (a in x.filter) !(o = fe[a].exec(s)) || (l[a] && !(o = l[a](o))) || ((r = o.shift()), i.push({ value: r, type: a, matches: o }), (s = s.slice(r.length)));
                    if (!r) break;
                }
                ...
                remove: function () {
                    return (
                        xe.each(arguments, function (e, t) {
                            for (var n; (n = xe.inArray(t, a, n)) > -1; ) a.splice(n, 1), n <= l && l--;
                        }),
                        this
                    );
                },
                                                ...
                                                (f = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                    ye(f)
                                                        ? o
                                                            ...
                                                            : (a++, f.call(e, i(a, n, l, o), i(a, n, c, o), i(a, n, l, n.notifyWith)))
                                                        : (r !== l && ((s = void 0), (u = [e])), (o || n.resolveWith)(s, u));
                                            }
                                        },
                                        p = o
                                            ? f
    ...
    (xe.event = {
                ...
                for (
                    ...
                    (d = m = (s = rt.exec(t[l]) || [])[1]),
                        ...
                        d &&
                            ...
                            (f = xe.event.special[d] || {}),
                            (c = xe.extend({ type: d, origType: m, data: r, handler: n, guid: n.guid, selector: o, needsContext: o && xe.expr.match.needsContext.test(o), namespace: h.join(".") }, i)),
            ...
            if (g && (u = g.events)) {
                for (l = (t = (t || "").match(Oe) || [""]).length; l--; )
                    if (((s = rt.exec(t[l]) || []), (d = m = s[1]), (h = (s[2] || "").split(".").sort()), d)) {
                        for (f = xe.event.special[d] || {}, p = u[(d = (r ? f.delegateType : f.bindType) || d)] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = i = p.length; i--; )
                            (c = p[i]),
                                (!o && m !== c.origType) ||
                                    (n && n.guid !== c.guid) ||
        ...
        dispatch: function (e) {
            ...
            if (((s.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, s))) {
                for (a = xe.event.handlers.call(this, s, l), t = 0; (o = a[t++]) && !s.isPropagationStopped(); )
                    for (s.currentTarget = o.elem, n = 0; (i = o.handlers[n++]) && !s.isImmediatePropagationStopped(); )
                        (s.rnamespace && !s.rnamespace.test(i.namespace)) ||
                            ((s.handleObj = i), (s.data = i.data), void 0 !== (r = ((xe.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, u)) && !1 === (s.result = r) && (s.preventDefault(), s.stopPropagation()));
    ...
    xe.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n) for (i = i || x(e), a = a || x(s), r = 0, o = i.length; r < o; r++) L(i[r], a[r]);
                else L(e, s);
            ...
            xe.cssHooks[t] = {
                ...
                set: function (e, n, r) {
                    var o,
                        ...
                        s = r && W(e, t, r, a, i);
                    return (
                        a && ve.scrollboxSize() === i.position && (s -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(i[t]) - W(e, t, "border", !1, i) - 0.5)),
    ...
    (xe.Animation = xe.extend(K, {
        ...
        xe.each({ slideDown: Y("show"), slideUp: Y("hide"), slideToggle: Y("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, t) {
            ...
            ajax: function (t, n) {
                function r(t, n, r, s) {
                    ...
                    c ||
                        ...
                        (w = oe(h, w, C, l)),
                        l
                            ? (h.ifModified && ((x = C.getResponseHeader("Last-Modified")) && (xe.lastModified[i] = x), (x = C.getResponseHeader("etag")) && (xe.etag[i] = x)),
                              204 === t || "HEAD" === h.type ? (T = "nocontent") : 304 === t ? (T = "notmodified") : ((T = w.state), (p = w.data), (l = !(d = w.error))))
                        ...
                        y.fireWith(m, [C, T]),
                        f && (g.trigger("ajaxComplete", [C, h]), --xe.active || xe.event.trigger("ajaxStop")));
                }
                ...
                (f = xe.event && h.global) && 0 == xe.active++ && xe.event.trigger("ajaxStart"),
                    ...
                    h.hasContent
                        ...
                        : ((d = h.url.slice(i.length)),
                          h.data && (h.processData || "string" == typeof h.data) && ((i += (jt.test(i) ? "&" : "?") + h.data), delete h.data),
                          !1 === h.cache && ((i = i.replace(Rt, "$1")), (d = (jt.test(i) ? "&" : "?") + "_=" + At++ + d)),
                          (h.url = i + d)),
    ...
    (function (e, t) {
        ...
        function m(e, n) {
            var o = re(),
                ...
                m = d({ top: a.top - s.top - f, left: a.left - s.left - p, width: a.width, height: a.height });
        ...
        function g(e) {
            var t = window.document.documentElement,
                ...
                i = u(t),
                a = u(t, "left");
            return d({ top: i - n.top + n.marginTop, left: a - n.left + n.marginLeft, width: r, height: o });
        }
        function v(e) {
            var r = e.nodeName;
        ...
        function D(t, n, r) {
            return (
                (void 0 === r ? t : t.slice(0, k(t, "name", r))).forEach(function (t) {
        ...
        function O(e, t, n, o) {
            var i = "BODY" === e.nodeName,
                a = i ? window : e;
            a.addEventListener(t, n, { passive: !0 }), i || O(r(a.parentNode), t, n, o), o.push(a);
        }
        function H(e, t, n, o) {
                ...
                modifiers: {
                        ...
                        fn: function (e) {
                            ...
                            if (r) {
                                var o = e.offsets,
                                    ...
                                    u = s ? "left" : "top",
                                    l = s ? "width" : "height",
                                    c = { start: ae({}, u, i[u]), end: ae({}, u, i[u] + i[l] - a[l]) };
                    ...
                    computeStyle: {
                        ...
                        fn: function (e, t) {
                            ...
                            var s,
                                u,
                                l = void 0 === a ? t.gpuAcceleration : a,
                                c = o(e.instance.popper),
                                f = h(c),
                                p = { position: i.position },
                                d = { left: X(i.left), top: X(i.top), bottom: X(i.bottom), right: X(i.right) },
                                m = "bottom" === n ? "top" : "bottom",
                                g = "right" === r ? "left" : "right",
                                v = j("transform");
                            if (((u = "bottom" == m ? -f.height + d.bottom : d.top), (s = "right" == g ? -f.width + d.right : d.left), l && v))
                                (p[v] = "translate3d(" + s + "px, " + u + "px, 0)"), (p[m] = 0), (p[g] = 0), (p.willChange = "transform");
                            else {
                                var y = "bottom" == m ? -1 : 1,
                                    b = "right" == g ? -1 : 1;
    ...
    (function () {
        function e() {
            if (!j && document.body) {
                ...
                if (((L = document.compatMode.indexOf("CSS") >= 0 ? t : e), (b = e), k.keyboardSupport && f("keydown", r), top != self)) N = !0;
                    ...
                    if (
                        ((a.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + L.scrollHeight + "px"),
                        ...
                        setTimeout(x, 10),
                        f("resize", x),
                        (w = new z(x)).observe(e, { attributes: !0, childList: !0, characterData: !1 }),
                        L.offsetHeight <= n)
                    ) {
        ...
        function t(e, t, n) {
            ...
            if ((M.push({ x: t, y: n, lastX: t < 0 ? 0.99 : -0.99, lastY: n < 0 ? 0.99 : -0.99, start: Date.now() }), !P)) {
        ...
        function n(n) {
            ...
            if (
                (H && (n.wheelDeltaX && h(n.wheelDeltaX, 120) && (a = (n.wheelDeltaX / Math.abs(n.wheelDeltaX)) * -120), n.wheelDeltaY && h(n.wheelDeltaY, 120) && (u = (n.wheelDeltaY / Math.abs(n.wheelDeltaY)) * -120)),
                a || u || (u = -n.wheelDelta || 0),
                1 === n.deltaMode && ((a *= 40), (u *= 40)),
                !k.touchpadSupport &&
                    (function (e) {
                        if (e)
                            return (
        ...
        var b,
            ...
            q = { left: 37, up: 38, right: 39, down: 40, spacebar: 32, pageup: 33, pagedown: 34, end: 35, home: 36 },
            M = [],
            P = !1,
            R = Date.now(),
            B =
                ...
                return (
                    this.each(function () {
                        ...
                        function i(e, t, n) {
                            ...
                            if (
                                (t && ((o = parseInt(D.css("top")) + ((e * parseInt(r.wheelStep)) / 100) * D.outerHeight()), (o = Math.min(Math.max(o, 0), i)), (o = e > 0 ? Math.ceil(o) : Math.floor(o)), D.css({ top: o + "px" })),
                                ...
                                (a = Math.min(Math.max(a, 0), i)), D.css({ top: a + "px" });
                            }
                            w.scrollTop(o), w.trigger("slimscrolling", ~~o), s(), u();
                        }
                        function a() {
                            (h = Math.max((w.outerHeight() / w[0].scrollHeight) * w.outerHeight(), y)), D.css({ height: h + "px" });
                        ...
                        if (w.parent().hasClass(r.wrapperClass)) {
                            ...
                            var E = e(v).addClass(r.wrapperClass).css({ position: "relative", overflow: "hidden", width: r.width, height: r.height });
                            w.css({ overflow: "hidden", width: r.width, height: r.height });
                            var S,
                                k = e(v)
                                ...
                                N = "right" == r.position ? { right: r.distance } : { left: r.distance };
                            k.css(N),
                                D.css(N),
                                w.wrap(E),
                                w.parent().append(D),
                                ...
                                a(),
                                "bottom" === r.start ? (D.css({ top: w.outerHeight() - D.outerHeight() }), i(0, !0)) : "top" !== r.start && (i(e(r.start).position().top, null, !0), r.alwaysVisible || D.hide()),
                                (S = this),
                                window.addEventListener ? (S.addEventListener("DOMMouseScroll", o, !1), S.addEventListener("mousewheel", o, !1)) : document.attachEvent("onmousewheel", o);
                        }
                    }),
                    this
                );
