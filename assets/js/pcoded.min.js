...
$(document).ready(function () {
    ...
    function s(e) {
        $(".header-chat .main-friend-chat").append(
            '<div class="media chat-messages"><div class="media-body chat-menu-reply"><div class=""><p class="chat-cont">' + $(".h-send-chat").val() + '</p></div><p class="chat-time">now</p></div></div>'
        ),
            d($(".h-send-chat").val()),
            i(),
    ...
    if (
        ...
        o <= 991 && ($(".main-search").addClass("open"), $(".main-search .form-control").css({ width: "90px" })),
        $(".main-friend-cont").slimScroll({ setTop: "1px", size: "5px", wheelStep: 10, touchScrollStep: 90, alwaysVisible: !1, allowPageScroll: !0, color: "rgba(0,0,0,0.5)", height: "calc(100vh - 92px)", width: "100%" }),
        $(".main-chat-cont").slimScroll({ setTop: "1px", size: "5px", wheelStep: 10, touchScrollStep: 90, alwaysVisible: !1, allowPageScroll: !0, color: "rgba(0,0,0,0.5)", height: "calc(100vh - 155px)", width: "100%" }),
        !$(".pcoded-navbar").hasClass("theme-horizontal"))
    ) {
        var o = $(window)[0].innerWidth;
        o < 992 || $(".pcoded-navbar").hasClass("menupos-static")
            ? $(".navbar-content").slimScroll({ setTop: "1px", size: "5px", wheelStep: 10, touchScrollStep: 90, alwaysVisible: !1, allowPageScroll: !0, color: "rgba(0,0,0,0.5)", height: "calc(100% - 70px)", width: "100%" })
            : $(".navbar-content").slimScroll({ setTop: "1px", size: "5px", wheelStep: 10, touchScrollStep: 90, alwaysVisible: !1, allowPageScroll: !0, color: "rgba(0,0,0,0.5)", height: "calc(100vh - 70px)", width: "100%" });
    }
